...
const PriceCards = ({ name, price, features, icon: IconComponent, selected }) => {
    ...
    return (
        <section style={{ width: "320px" }} className='card animate__animated animate__slideInDown'>
            <Card sx={cardStyle}>
                <IconComponent sx={{
                    padding: "10px", fontFamily: theme.typography.fontFamily, fontSize: "18px", fontWeight: "600",
                ...
                <Typography
                    ...
                    variant="h6"
                    component="div"
                    sx={{ color: theme.palette.primary.main, fontFamily: theme.typography.fontFamily, fontSize: "12px", fontWeight: "600" }}
                >
                    {name}
                </Typography>
                <Typography
                ...
                <div className="features" style={{ marginTop: "20px" }}>
                    {features.map((feature, index) => (
                        <div key={index} style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
                            ...
                            <Typography variant="body2" sx={{ fontFamily: "Quicksand", color: theme.palette.text.secondary, margin: "5px", fontSize: "10px" }}>
                                {feature}
                            </Typography>
                        </div>
                    ))}
