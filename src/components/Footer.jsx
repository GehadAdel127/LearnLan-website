        ...
        <footer style={{ display: "flex", justifyContent: "space-between", alignItems: "start", flexDirection: "column", padding: "50px" }}>
            <div className="footerContent" style={{ display: "flex", justifyContent: "center", alignItems: "start", gap: "50px" }}>
                ...
                <div className="courses" style={{ width: "21%" }}>
                    ...
                    <AnimatedSection animationClass="slideInUp">
                        <div className="coursesContent" style={{ display: "flex", flexDirection: "column", justifyContent: "start", alignItems: "start", gap: "10px", marginTop: "22px" }}>
                ...
                <div className="contact" style={{ width: "21%" }}>
                    ...
                    <AnimatedSection animationClass="slideInUp">
                        <div className="contactContent" style={{ display: "flex", flexDirection: "column", justifyContent: "start", alignItems: "start", gap: "10px" }}>
                            <p>Call us:</p>
                            <span>
                                +20(1234567890)
                            </span>
